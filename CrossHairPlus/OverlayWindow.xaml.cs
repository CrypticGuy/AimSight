...
public partial class OverlayWindow : Window
{
    ...
    private void OnLoaded(object sender, RoutedEventArgs e)
    {
        ...
        // Set window to be transparent to clicks, hide from Alt+Tab, and stay on top
        var extendedStyle = Win32.GetWindowLong(hwnd, Win32.GWL_EXSTYLE);
        Win32.SetWindowLong(hwnd, Win32.GWL_EXSTYLE, extendedStyle | Win32.WS_EX_TRANSPARENT | Win32.WS_EX_TOOLWINDOW | Win32.WS_EX_TOPMOST);

        // Force window to topmost immediately
        Win32.SetWindowPos(hwnd, new IntPtr(-1), 0, 0, 0, 0, Win32.SWP_NOMOVE | Win32.SWP_NOSIZE | Win32.SWP_NOACTIVATE);
        ...
        // Start timer to periodically refresh topmost status
    ...
    private void UpdatePosition()
    {
        ...
        // Ensure topmost after position change
        var hwnd = new WindowInteropHelper(this).Handle;
        if (hwnd != IntPtr.Zero)
        {
            Win32.SetWindowPos(hwnd, new IntPtr(-1), 0, 0, 0, 0, Win32.SWP_NOMOVE | Win32.SWP_NOSIZE | Win32.SWP_NOACTIVATE);
